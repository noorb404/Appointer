...
public class BusinessProfileProducts extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_business_profile_products);
        ...
        /*goldline*/
        final TextView goldl=findViewById(R.id.prgoldline);
        ...
        if(DESTINATION.getBUSINESS().getProducts()!=null)
            initPhotos();
        ...
        SCHEDULEb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(BusinessProfileProducts.this,p);
    ...
    private void initPhotos() {
        ...
        if (DESTINATION.getBUSINESS().getImages().size()!=0 && BusinessFlag==0) {
            ...
            PhotoViewAdapter photoViewAdapter = new PhotoViewAdapter(DESTINATION.getBUSINESS().getProducts(), this);
            ...
            RecyclerView recyclerView = findViewById(R.id.HaircutsList);
            recyclerView.setLayoutManager(layoutManager);
            PhotoViewAdapter photoViewAdapter = new PhotoViewAdapter(USER.getBUSINESS().getProducts(), this);
            recyclerView.setAdapter(photoViewAdapter);

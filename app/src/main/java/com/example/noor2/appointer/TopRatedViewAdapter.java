...
public class TopRatedViewAdapter extends RecyclerView.Adapter<TopRatedViewAdapter.ViewHolder> {
    ...
    public TopRatedViewAdapter(ArrayList<Integer> imgs, ArrayList<String> names, ArrayList<String> loactions, Context c)
    {
        this.images=imgs;
        this.names=names;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_toprated,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        ViewHolder(View itemView)
        {
            ...
            saloonName=itemView.findViewById(R.id.saloonName);
            saloonLoaction=itemView.findViewById(R.id.saloonLoaction);
